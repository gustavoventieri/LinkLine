 ...
 * Fornece métodos para envio de emails com códigos de confirmação, redefinição de senha,
...
public class EmailUtils {
     ...
     * Construtor padrão.
     *
     * @param fromEmail     endereço de email remetente (configurado em spring.mail.username)
     * @param mailSender    serviço para envio de emails
     * @param templateEngine mecanismo de templates Thymeleaf
     */
    public EmailUtils(@Value("${spring.mail.username}") String fromEmail,
    ...
    /**
     * Envia um email contendo código para redefinição de senha para o endereço especificado.
     *
     * @param to   endereço de email do destinatário
    ...
    /**
     * Envia um email notificando a criação de uma nova conta para o usuário especificado.
     *
     * @param to       endereço de email do destinatário
     ...
     * @throws MessagingException caso ocorra erro no envio do email
     */
    private void sendEmailFromTemplate(String to, String subject, String templateName, Map<String, Object> variables) throws MessagingException {
