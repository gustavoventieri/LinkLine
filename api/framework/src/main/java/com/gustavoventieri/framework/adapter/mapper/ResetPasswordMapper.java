...
public class ResetPasswordMapper {
    ...
    public static ResetPasswordDomain toDomain(ResetPassword entity) {
        ...
        return new ResetPasswordDomain(
            ...
            entity.getEmail(),
            entity.getCode(),
            entity.getExpiresAt() != null ? entity.getExpiresAt().atZone(java.time.ZoneId.systemDefault()).toInstant(): null,
            entity.getCreatedAt()
        );
    }
    ...
    public static ResetPassword toEntity(ResetPasswordDomain domain) {
        ...
        return new ResetPassword(
            ...
            domain.email(),
            domain.code(),
            domain.expiresAt() != null ? domain.expiresAt().atZone(java.time.ZoneId.systemDefault()).toInstant() : null,
            domain.createdAt()
        );
    }
}
